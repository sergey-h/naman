...
if ( ! class_exists( 'WPEX_Post_Metaboxes' ) ) {
	class WPEX_Post_Metaboxes {
		...
		public function display_meta_box( $post ) {
			...
			// Create filter for extending the tabs before looping through them
			$tabs = apply_filters( 'wpex_metabox_tabs', $tabs );
		...
		public function tabs_array() {
			...
			$array['header'] = array(
				...
				'settings'	=> array(
					...
					array(
						'title'			=> __( 'Overlay Header Custom Logo', 'wpex'),
			...
			$array['callout'] = array(
				...
				'settings'	=> array(
					...
					array(
						...
						'type'		=> 'text',
						//'description'	=> __( 'Enter a url.', 'wpex' ),
					),
					array(
			...
			$array = apply_filters( 'wpex_metabox_main_tab', $array );
			return $array;
		}
